...
/* Il modulo timer richiede i timer HAL (TIM_HandleTypeDef).
 * Viene compilato solo se HAL_TIM_MODULE_ENABLED e' definito
 * in stm32g4xx_hal_conf.h (cioe' se nel CubeMX e' configurato un timer). */

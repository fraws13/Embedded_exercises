...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin){
	...
	//non è la soluzione, si potrebbe inserire un filtrp passa basso e vedere se per tot letture è stabile allora mi prendo il segnale
	//lato software mascheri gli eventi oscuri
